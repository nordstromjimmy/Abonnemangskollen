...
const SubscriptionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'customInterval': PropertySchema(
      id: 2,
      name: r'customInterval',
      type: IsarType.long,
    ),
    ...
    r'period': PropertySchema(
      ...
      name: r'period',
      type: IsarType.byte,
      enumMap: _SubscriptionperiodEnumValueMap,
    ),
...
void _subscriptionSerialize(
  ...
  writer.writeLong(offsets[2], object.customInterval);
  writer.writeBool(offsets[3], object.isActive);
  writer.writeString(offsets[4], object.name);
  writer.writeDateTime(offsets[5], object.nextRenewal);
  writer.writeString(offsets[6], object.notes);
  writer.writeLong(offsets[7], object.notifyDaysBefore);
...
Subscription _subscriptionDeserialize(
  ...
  object.customInterval = reader.readLongOrNull(offsets[2]);
  object.id = id;
  object.isActive = reader.readBool(offsets[3]);
  object.name = reader.readString(offsets[4]);
  object.nextRenewal = reader.readDateTime(offsets[5]);
  object.notes = reader.readStringOrNull(offsets[6]);
  object.notifyDaysBefore = reader.readLong(offsets[7]);
  object.period =
      _SubscriptionperiodValueEnumMap[reader.readByteOrNull(offsets[8])] ??
...
P _subscriptionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 8:
      return (_SubscriptionperiodValueEnumMap[reader.readByteOrNull(offset)] ??
              BillingPeriod.monthly)
          as P;
    case 9:
...
const _SubscriptionperiodEnumValueMap = {
  'monthly': 0,
  'quarterly': 1,
  'yearly': 2,
  'custom': 3,
};
const _SubscriptionperiodValueEnumMap = {
  0: BillingPeriod.monthly,
  1: BillingPeriod.quarterly,
  2: BillingPeriod.yearly,
  3: BillingPeriod.custom,
};
...
extension SubscriptionQueryFilter
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  customIntervalIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'customInterval'),
      );
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  customIntervalIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'customInterval'),
      );
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  customIntervalEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'customInterval', value: value),
      );
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  customIntervalGreaterThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
          property: r'customInterval',
          value: value,
        ),
      );
    });
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  customIntervalLessThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
  ...
  nextRenewalEqualTo(DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'nextRenewal', value: value),
      );
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  nextRenewalGreaterThan(DateTime value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  nextRenewalLessThan(DateTime value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  notifyDaysBeforeEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition> periodEqualTo(
    BillingPeriod value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  periodGreaterThan(BillingPeriod value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  periodLessThan(BillingPeriod value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition> periodBetween(
    BillingPeriod lower,
    BillingPeriod upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SubscriptionQuerySortBy
  ...
  sortByCustomInterval() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customInterval', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy>
  sortByCustomIntervalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customInterval', Sort.desc);
    });
  }
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByNextRenewal() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy>
  sortByNotifyDaysBeforeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notifyDaysBefore', Sort.desc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByPeriod() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'period', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByPeriodDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQuerySortThenBy
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByNextRenewal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'nextRenewal', Sort.asc);
    });
  }
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy>
  thenByNotifyDaysBeforeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notifyDaysBefore', Sort.desc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByPeriod() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'period', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByPeriodDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'period', Sort.desc);
    });
  }
...
extension SubscriptionQueryWhereDistinct
  ...
  distinctByCustomInterval() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'customInterval');
    });
  }
  ...
  QueryBuilder<Subscription, Subscription, QDistinct> distinctByNextRenewal() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subscription, Subscription, QDistinct>
  distinctByNotifyDaysBefore() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'notifyDaysBefore');
    });
  }

  QueryBuilder<Subscription, Subscription, QDistinct> distinctByPeriod() {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQueryProperty
  ...
  QueryBuilder<Subscription, int?, QQueryOperations> customIntervalProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'customInterval');
    });
  }
  ...
  QueryBuilder<Subscription, DateTime, QQueryOperations> nextRenewalProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subscription, int, QQueryOperations> notifyDaysBeforeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notifyDaysBefore');
    });
  }

  QueryBuilder<Subscription, BillingPeriod, QQueryOperations> periodProperty() {
    return QueryBuilder.apply(this, (query) {
